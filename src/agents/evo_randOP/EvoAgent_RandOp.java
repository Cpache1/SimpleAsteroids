...
public class EvoAgent_RandOp implements SimplePlayerInterface {
    ...
    public EvoAgent_RandOp setEvoAlg(EvoAlg evoAlg, int nEvals) {
        this.evoAlg = evoAlg;
        this.nEvals = nEvals;
    ...
    public EvoAgent_RandOp setUseShiftBuffer(boolean useShiftBuffer) {
    ...
    public EvoAgent_RandOp setDimension(Dimension dimension) {
        this.dimension = dimension;
        return this;
    }

    public EvoAgent_RandOp setVisual() {
        playoutPlotter = new PlayoutPlotter().setDimension(dimension);
        playoutPlotter.startPlot(sequenceLength);
        return this;
    }

    public EvoAgent_RandOp setSequenceLength(int sequenceLength) {
    ...
    public EvoAgent_RandOp setOpponent(SimplePlayerInterface opponent) {
